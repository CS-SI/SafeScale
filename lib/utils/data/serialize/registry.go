...
type propertyTypeRegistry map[string]map[string]clonable.Clonable

// Register allows to register a new association
func (r propertyTypeRegistry) Register(module, key string, zeroValue clonable.Clonable) {
	if _, found := r[module]; !found {
		r[module] = map[string]clonable.Clonable{}
	}
...
func (r propertyTypeRegistry) ZeroValue(module, key string) clonable.Clonable {

...
type SecurityGroup interface {
	...
	BindToHost(concurrency.Task, Host, SecurityGroupActivation) fail.Error                                             // binds a security group to a host
	BindToSubnet(concurrency.Task, Subnet, SecurityGroupActivation) fail.Error                                         // binds a security group to a network

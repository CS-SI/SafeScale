...
func (s *Stack) InitDefaultSecurityGroup() fail.Error {
    s.Stack.DefaultSecurityGroupName = "vpc-sg-safescale." + s.authOpts.VPCName
    s.Stack.DefaultSecurityGroupDescription = "SafeScale Default Security Group for VPC " + s.authOpts.VPCName

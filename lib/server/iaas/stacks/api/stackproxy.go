...
func (sp StackProxy) GetImage(id string) (*abstract.Image, error) {
	rv, err := sp.InnerStack.GetImage(id)
	return rv, errorTranslator(err)
}

func (sp StackProxy) GetTemplate(id string) (*abstract.HostTemplate, error) {
	rv, err := sp.InnerStack.GetTemplate(id)
	return rv, errorTranslator(err)
}

func (sp StackProxy) CreateKeyPair(name string) (*abstract.KeyPair, error) {
	rv, err := sp.InnerStack.CreateKeyPair(name)
	return rv, errorTranslator(err)
}

func (sp StackProxy) GetKeyPair(id string) (*abstract.KeyPair, error) {
	rv, err := sp.InnerStack.GetKeyPair(id)
	return rv, errorTranslator(err)
}

func (sp StackProxy) ListKeyPairs() ([]abstract.KeyPair, error) {
...
func (sp StackProxy) CreateNetwork(req abstract.NetworkRequest) (*abstract.Network, error) {
	rv, err := sp.InnerStack.CreateNetwork(req)
	return rv, errorTranslator(err)
}

func (sp StackProxy) GetNetwork(id string) (*abstract.Network, error) {
	rv, err := sp.InnerStack.GetNetwork(id)
	return rv, errorTranslator(err)
}

func (sp StackProxy) GetNetworkByName(name string) (*abstract.Network, error) {
	rv, err := sp.InnerStack.GetNetworkByName(name)
	return rv, errorTranslator(err)
}

func (sp StackProxy) ListNetworks() ([]*abstract.Network, error) {
...
func (sp StackProxy) CreateGateway(req abstract.GatewayRequest, sizing *abstract.SizingRequirements) (*abstract.Host, *userdata.Content, error) {
...
func (sp StackProxy) CreateVIP(s string, s2 string) (*abstract.VirtualIP, error) {
...
func (sp StackProxy) CreateHost(request abstract.HostRequest) (*abstract.Host, *userdata.Content, error) {
	rv, rv2, err := sp.InnerStack.CreateHost(request)
	return rv, rv2, errorTranslator(err)
}

func (sp StackProxy) InspectHost(i interface{}) (*abstract.Host, error) {
	rv, err := sp.InnerStack.InspectHost(i)
	return rv, errorTranslator(err)
}

func (sp StackProxy) GetHostByName(s string) (*abstract.Host, error) {
...
func (sp StackProxy) ListHosts() ([]*abstract.Host, error) {
...
func (sp StackProxy) ResizeHost(id string, request abstract.SizingRequirements) (*abstract.Host, error) {
	rv, err := sp.InnerStack.ResizeHost(id, request)
	return rv, errorTranslator(err)
}

func (sp StackProxy) CreateVolume(request abstract.VolumeRequest) (*abstract.Volume, error) {
	rv, err := sp.InnerStack.CreateVolume(request)
	return rv, errorTranslator(err)
}

func (sp StackProxy) GetVolume(id string) (*abstract.Volume, error) {
	rv, err := sp.InnerStack.GetVolume(id)
	return rv, errorTranslator(err)
}

func (sp StackProxy) ListVolumes() ([]abstract.Volume, error) {
...
func (sp StackProxy) CreateVolumeAttachment(request abstract.VolumeAttachmentRequest) (string, error) {
	rv, err := sp.InnerStack.CreateVolumeAttachment(request)
	return rv, errorTranslator(err)
}

func (sp StackProxy) GetVolumeAttachment(serverID, id string) (*abstract.VolumeAttachment, error) {
	rv, err := sp.InnerStack.GetVolumeAttachment(serverID, id)
	return rv, errorTranslator(err)
}

func (sp StackProxy) ListVolumeAttachments(serverID string) ([]abstract.VolumeAttachment, error) {

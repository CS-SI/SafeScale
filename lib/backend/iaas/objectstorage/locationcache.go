...
func (l locationcache) InspectBucket(ctx context.Context, s string) (*abstract.Bucket, fail.Error) {
	return l.inner.InspectBucket(ctx, s)
}

func (l locationcache) CreateBucket(ctx context.Context, s string) (*abstract.Bucket, fail.Error) {

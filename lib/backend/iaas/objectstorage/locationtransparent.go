...
func (l locationtransparent) InspectBucket(ctx context.Context, s string) (*abstract.Bucket, fail.Error) {
	return l.inner.InspectBucket(ctx, s)
}

func (l locationtransparent) CreateBucket(ctx context.Context, s string) (*abstract.Bucket, fail.Error) {

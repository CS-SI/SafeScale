...
func (instance *stack) CreateNetwork(ctx context.Context, req abstract.NetworkRequest) (an *abstract.Network, ferr fail.Error) {
	if valid.IsNil(instance) {
		return nil, fail.InvalidInstanceError()
	}
	if req.CIDR == "" {
	...
	resp, xerr := instance.rpcCreateNetwork(ctx, req.Name, req.CIDR)
	if xerr != nil {
		return nil, xerr
	}
	...
	defer func() {
		...
		if ferr != nil && req.CleanOnFailure() {
			if derr := instance.DeleteNetwork(context.Background(), resp.NetId); derr != nil {
	...
	securityGroup, xerr := instance.rpcReadSecurityGroupByName(ctx, resp.NetId, "default")
	if xerr != nil {
		return nil, xerr
	}

	xerr = instance.updateDefaultSecurityRules(ctx, securityGroup)
	if xerr != nil {
		return nil, fail.Wrap(xerr, "failed to update default security group of Network/VPC")
	}

	if xerr = instance.createDHCPOptionSet(ctx, req, resp); xerr != nil {
		return nil, fail.Wrap(xerr, "failed to create DHCP options set of Network/VPC")
	}

	if xerr = instance.createInternetService(ctx, req, resp); xerr != nil {
...
func (instance *stack) createDHCPOptionSet(ctx context.Context, req abstract.NetworkRequest, net osc.Net) (ferr fail.Error) {
	if len(req.DNSServers) == 0 {
		return nil
	}

	ntpServers, xerr := instance.getDefaultDhcpNtpServers(ctx, net)
	if xerr != nil {
		return xerr
	}

	resp, xerr := instance.rpcCreateDhcpOptions(ctx, req.Name, req.DNSServers, ntpServers)
	if xerr != nil {
		return xerr
	}
	...
	defer func() {
		ferr = debug.InjectPlannedFail(ferr)
		if ferr != nil {
			derr := instance.deleteDhcpOptions(context.Background(), net, false)
			_ = ferr.AddConsequence(derr)
		}
	}()

	return instance.rpcUpdateNet(ctx, net.NetId, resp.DhcpOptionsSetId)
}

func (instance *stack) getDefaultDhcpNtpServers(ctx context.Context, net osc.Net) ([]string, fail.Error) {
	resp, xerr := instance.rpcReadDhcpOptionsByID(ctx, net.DhcpOptionsSetId)
	if xerr != nil {
		return []string{}, xerr
	}
	if len(resp) != 1 {
...
func (instance *stack) deleteDhcpOptions(ctx context.Context, onet osc.Net, checkName bool) fail.Error {
	// Remove DHCP options
	namedDHCPOptions, xerr := instance.checkDHCPOptionsName(ctx, onet)
	if xerr != nil {
		return xerr
	}
	...
	return instance.rpcDeleteDhcpOptions(ctx, onet.DhcpOptionsSetId)
}

func (instance *stack) checkDHCPOptionsName(ctx context.Context, onet osc.Net) (bool, fail.Error) {
	tags, xerr := instance.rpcReadTagsOfResource(ctx, onet.DhcpOptionsSetId)
	if xerr != nil {
		return false, xerr
	}
...
func (instance *stack) createInternetService(ctx context.Context, req abstract.NetworkRequest, onet osc.Net) fail.Error {
	// Create internet service to allow internet access from VMs attached to the network
	resp, xerr := instance.rpcCreateInternetService(ctx, req.Name)
	if xerr != nil {
		return xerr
	}

	if xerr := instance.rpcLinkInternetService(ctx, onet.NetId, resp.InternetServiceId); xerr != nil {
		return xerr
	}

	return instance.updateRouteTable(ctx, onet, resp)
}

func (instance *stack) deleteInternetService(ctx context.Context, netID string) fail.Error {
	// Unlink and delete internet service
	resp, xerr := instance.rpcReadInternetServices(ctx, nil)
	if xerr != nil {
		switch xerr.(type) {
	...
	for _, ois := range resp {
		...
		if xerr := instance.rpcUnlinkInternetService(ctx, netID, ois.InternetServiceId); xerr != nil {
			return fail.Wrap(xerr, "failed to unlink Internet Service %s from Network %s", ois.InternetServiceId, netID)
		}

		if xerr := instance.rpcDeleteInternetService(ctx, ois.InternetServiceId); xerr != nil {
...
func (instance *stack) updateRouteTable(ctx context.Context, onet osc.Net, is osc.InternetService) fail.Error {
	table, xerr := instance.getDefaultRouteTable(ctx, onet.NetId)
	if xerr != nil {
		return xerr
	}

	return instance.rpcCreateRoute(ctx, is.InternetServiceId, table.RouteTableId, "0.0.0.0/0")
}

func (instance *stack) getDefaultRouteTable(ctx context.Context, id string) (osc.RouteTable, fail.Error) {
	if id == "" {
		return osc.RouteTable{}, fail.InvalidParameterError("id", "cannot be empty string")
	}

	resp, xerr := instance.rpcReadRouteTableOfNetwork(ctx, id)
	if xerr != nil {
		switch xerr.(type) {
		case *fail.ErrNotFound:
...
func (instance *stack) InspectNetwork(ctx context.Context, id string) (_ *abstract.Network, ferr fail.Error) {
	...
	resp, xerr := instance.rpcReadNetByID(ctx, id)
	if xerr != nil {
		return nil, xerr
	}
...
func (instance *stack) InspectNetworkByName(ctx context.Context, name string) (_ *abstract.Network, ferr fail.Error) {
	...
	resp, xerr := instance.rpcReadNetByName(ctx, name)
	if xerr != nil {
		return nil, xerr
	}
...
func (instance *stack) ListNetworks(ctx context.Context) (_ []*abstract.Network, ferr fail.Error) {
	...
	resp, xerr := instance.rpcReadNets(ctx, nil)
	if xerr != nil {
...
func (instance *stack) DeleteNetwork(ctx context.Context, networkParam iaasapi.NetworkIdentifier) (ferr fail.Error) {
	...
	resp, xerr := instance.rpcReadNics(ctx, an.ID, "")
	if xerr != nil {
		switch xerr.(type) {
		case *fail.ErrNotFound:
		...
		if xerr = instance.deleteNICs(ctx, resp); xerr != nil {
			return xerr
		}
	}

	// Delete Internet Gateway
	if xerr = instance.deleteInternetService(ctx, an.ID); xerr != nil {
		switch xerr.(type) {
		case *fail.ErrNotFound:
	...
	// delete VPC
	return instance.rpcDeleteNetwork(ctx, an.ID)
}

// CreateSubnet creates a Subnet
func (instance *stack) CreateSubnet(ctx context.Context, req abstract.SubnetRequest) (as *abstract.Subnet, ferr fail.Error) {
	if valid.IsNil(instance) {
		return nil, fail.InvalidInstanceError()
	}
	...
	vpc, xerr := instance.InspectNetwork(ctx, req.NetworkID)
	if xerr != nil {
		return nil, xerr
	}
	...
	resp, xerr := instance.rpcCreateSubnet(ctx, req.Name, vpc.ID, req.CIDR)
	if xerr != nil {
		return nil, xerr
	}
	...
	defer func() {
		ferr = debug.InjectPlannedFail(ferr)
		if ferr != nil && req.CleanOnFailure() {
			if derr := instance.rpcDeleteSubnet(context.Background(), resp.SubnetId); derr != nil {
...
func (instance *stack) InspectSubnet(ctx context.Context, id string) (_ *abstract.Subnet, ferr fail.Error) {
	...
	resp, xerr := instance.rpcReadSubnetByID(ctx, id)
	if xerr != nil {
		return nil, xerr
	}
...
func (instance *stack) InspectSubnetByName(ctx context.Context, networkRef, subnetName string) (_ *abstract.Subnet, ferr fail.Error) {
	...
	an, xerr := instance.InspectNetwork(ctx, networkRef)
	if xerr != nil {
		switch xerr.(type) {
		case *fail.ErrNotFound:
			an, xerr = instance.InspectNetworkByName(ctx, networkRef)
			if xerr != nil {
				return nil, xerr
			}
		default:
	...
	resp, xerr := instance.rpcReadSubnets(ctx, networkID, nil)
	if xerr != nil {
		switch xerr.(type) {
		case *fail.ErrNotFound:
...
func (instance *stack) ListSubnets(ctx context.Context, networkRef string) (_ []*abstract.Subnet, ferr fail.Error) {
	...
	if networkRef == "" {
		networkRef = instance.Options.Network.DefaultNetworkName
		if networkRef == "" {
	...
	if xerr != nil {
		switch xerr.(type) {
		case *fail.ErrNotFound:
			if an, xerr = instance.InspectNetworkByName(ctx, networkRef); xerr != nil {
				return emptySlice, xerr
			}
		default:
			return emptySlice, xerr
	...
	resp, xerr := instance.rpcReadSubnets(ctx, an.ID, nil)
	if xerr != nil {
		return emptySlice, xerr
	}
...
func (instance *stack) listSubnetsByHost(ctx context.Context, hostID string) ([]*abstract.Subnet, []osc.Nic, fail.Error) {
	var (
		emptySubnetSlice []*abstract.Subnet
		emptyNicSlice    []osc.Nic
	)

	resp, xerr := instance.rpcReadNics(ctx, "", hostID)
	if xerr != nil {
	...
	for _, nic := range resp {
		item, xerr := instance.InspectSubnet(ctx, nic.SubnetId)
		if xerr != nil {
			switch xerr.(type) {
			case *fail.ErrNotFound:
				continue
	...
	if len(resp) > 0 {
		for _, nic := range resp {
			if nic.LinkNic.LinkNicId != "" {
				xerr = instance.rpcUnLinkNic(ctx, nic.LinkNic.LinkNicId)
				if xerr != nil {
					debug.IgnoreError(xerr)
				}
			}
...
func (instance *stack) updateDefaultSecurityRules(ctx context.Context, sg osc.SecurityGroup) fail.Error {
	rules := append(instance.createTCPPermissions(), instance.createUDPPermissions()...)
	rules = append(rules, instance.createICMPPermissions()...)
	xerr := instance.rpcCreateSecurityGroupRules(ctx, sg.SecurityGroupId, "Inbound", rules)
	if xerr != nil {
		return fail.Wrap(xerr, "failed to add Network ingress rules to Security Group %s", sg.SecurityGroupId)
	}

	xerr = instance.rpcCreateSecurityGroupRules(ctx, sg.SecurityGroupId, "Outbound", rules)
	if xerr != nil {
...
func (instance *stack) createTCPPermissions() []osc.SecurityGroupRule {
...
// open all ports, ingress is controlled by the vm firewall
func (instance *stack) createUDPPermissions() []osc.SecurityGroupRule {
	rule := osc.SecurityGroupRule{
		FromPortRange: 1,
		ToPortRange:   65535,
		IpRanges:      []string{"0.0.0.0/0"},
...
func (instance *stack) createICMPPermissions() []osc.SecurityGroupRule {

...
func Test_NewNetwork(t *testing.T) {
	...
	xerr := NewServiceTest(t, func(svc *ServiceTest) {
		...
		require.EqualValues(t, reflect.TypeOf(network).String(), "*resources.Network")
...
func TestNetwork_InspectSubnet(t *testing.T) {
	...
	xerr := NewServiceTest(t, func(svc *ServiceTest) {
		...
		require.Nil(t, err)
		require.EqualValues(t, reflect.TypeOf(osubnet).String(), "*resources.Subnet")
...
func Test_FreeCIDRForSingleHost(t *testing.T) {
	...
	xerr := NewServiceTest(t, func(svc *ServiceTest) {
		...
		xerr = trxFreeCIDRForSingleHost(ctx, network, 21)
		require.Nil(t, xerr)

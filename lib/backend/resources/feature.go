...
//go:generate minimock -i github.com/CS-SI/SafeScale/v22/lib/backend/resources.Targetable -o mocks/mock_target.go
//go:generate minimock -i github.com/CS-SI/SafeScale/v22/lib/backend/resources.Feature -o mocks/mock_feature.go
...
type Targetable interface {
	...
	Service() iaasapi.Service                                                                              // returns the iaas.Service used by the target

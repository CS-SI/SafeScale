...
func (e *ServiceTest) AddRulesToSecurityGroup(ctx context.Context, sgParam stacks.SecurityGroupParameter, rules ...*abstract.SecurityGroupRule) (*abstract.SecurityGroup, fail.Error) {
	asg, _, xerr := stacks.ValidateSecurityGroupParameter(sgParam)
	if xerr != nil {
	...
	xerr = e._updateSecurityGroup(asg.Network, asg.Name, func(asg *abstract.SecurityGroup) *abstract.SecurityGroup {
		asg.Rules = append(asg.Rules, rules...)
		return asg
	})
...
func (e *ServiceTest) DeleteRulesFromSecurityGroup(ctx context.Context, sgParam stacks.SecurityGroupParameter, rules ...*abstract.SecurityGroupRule) (*abstract.SecurityGroup, fail.Error) {
	...
	xerr = e._updateSecurityGroup(asg.Network, asg.Name, func(asg *abstract.SecurityGroup) *abstract.SecurityGroup {
		newRules := make([]*abstract.SecurityGroupRule, 0)
...
func (e *ServiceTest) EnableSecurityGroup(ctx context.Context, asg *abstract.SecurityGroup) fail.Error {
	...
	return sg.Inspect(ctx, func(_ clonable.Clonable, props *serialize.JSONProperties) fail.Error {
		return props.Inspect(securitygroupproperty.HostsV1, func(p clonable.Clonable) fail.Error {
			sghV1, err := clonable.Cast[*propertiesv1.SecurityGroupHosts](p)
			if err != nil {
				return fail.Wrap(err)
			}
...
func (e *ServiceTest) BindSecurityGroupToHost(ctx context.Context, sgParam stacks.SecurityGroupParameter, hostParam common.HostParameter) (ferr fail.Error) {
	...
	//return sg.Alter(ctx, func(_ clonable.Clonable, props *serialize.JSONProperties) fail.Error {
	//	return props.Alter(securitygroupproperty.HostsV1, func(p clonable.Clonable) fail.Error {
	//		sghV1, err := clonable.Cast[*propertiesv1.SecurityGroupHosts)
	//		if !ok {
...
func (e *ServiceTest) CreateNetwork(ctx context.Context, req abstract.NetworkRequest) (an *abstract.Network, ferr fail.Error) {
	...
	xerr = network.Alter(ctx, func(_ clonable.Clonable, props *serialize.JSONProperties) fail.Error {
		...
		xerr = props.Alter(networkproperty.DescriptionV1, func(p clonable.Clonable) fail.Error {
			...
			networkDescriptionV1, err := clonable.Cast[*propertiesv1.NetworkDescription](p)
			if err != nil {
				return fail.Wrap(err)
			}
...
func (e *ServiceTest) CreateSubnet(ctx context.Context, req abstract.SubnetRequest) (as *abstract.Subnet, ferr fail.Error) {
	...
	xerr = subnet.Alter(ctx, func(_ clonable.Clonable, props *serialize.JSONProperties) fail.Error {
		...
		/*
			 xerr = props.Alter(subnetproperty.SecurityGroupsV1, func(p clonable.Clonable) fail.Error {
				 ...
				 ssgV1, err := clonable.Cast[*propertiesv1.SubnetSecurityGroups)
				 if !ok {
		...
		*/
		...
		/*
			 xerr = props.Alter(subnetproperty.HostsV1, func(p clonable.Clonable) fail.Error {
				 ...
				 subnetHostsV1, err := clonable.Cast[*propertiesv1.SubnetHosts)
				 if !ok {
		...
		*/
		...
		xerr = props.Alter(subnetproperty.DescriptionV1, func(p clonable.Clonable) fail.Error {
			subnetDescriptionV1, err := clonable.Cast[*propertiesv1.SubnetDescription](p)
			if err != nil {
				return fail.Wrap(err)
			}
	...
	xerr = network.Alter(ctx, func(_ clonable.Clonable, props *serialize.JSONProperties) fail.Error {
		return props.Alter(networkproperty.SubnetsV1, func(p clonable.Clonable) fail.Error {
			subnetsV1, err := clonable.Cast[*propertiesv1.NetworkSubnets](p)
			if err != nil {
				return fail.Wrap(err)
			}
...
func (e *ServiceTest) CreateHostWithKeyPair(ctx context.Context, request abstract.HostRequest) (*abstract.HostFull, *userdata.Content, *abstract.KeyPair, fail.Error) {
	...
	if err != nil {
		return nil, nil, nil, fail.Wrap(err)
	}
...
func (e *ServiceTest) CreateHost(ctx context.Context, request abstract.HostRequest) (*abstract.HostFull, *userdata.Content, fail.Error) {
	...
	// Pre-save host core
	err := e._setInternalData(fmt.Sprintf("hosts/byID/%s", name), ahf.HostCore)
	if err != nil {
		return ahf, uc, fail.Wrap(err)
	}
	err = e._setInternalData(fmt.Sprintf("hosts/byName/%s", name), ahf.Hostore)
	if err != nil {
		return ahf, uc, fail.Wrap(err)
	}

	// abstract.HostFull to resources.host
	host, xerr := NewCore(e, "host", "hosts", ahf.HostCore)
	if xerr != nil {
		return ahf, uc, xerr
	}
	xerr = host.Carry(ctx, ahf.HostCore)
	if xerr != nil {
		return ahf, uc, xerr
	}
	...
	xerr = host.Alter(ctx, func(p clonable.Clonable, props *serialize.JSONProperties) fail.Error {
		innerXErr := props.Alter(hostproperty.SizingV2, func(p clonable.Clonable) fail.Error {
			hostSizingV2, err := clonable.Cast[*propertiesv2.HostSizing](p)
			if err != nil {
				return fail.Wrap(err)
			}
		...
		innerXErr = props.Alter(hostproperty.NetworkV2, func(p clonable.Clonable) fail.Error {
			network, err := clonable.Cast[*propertiesv2.HostNetworking](p)
			if err != nil {
				return fail.Wrap(err)
			}
		...
		innerXErr = props.Alter(hostproperty.DescriptionV1, func(p clonable.Clonable) fail.Error {
			description, err := clonable.Cast[*propertiesv1.HostDescription](p)
			if err != nil {
				return fail.Wrap(err)
			}
...
func (e *ServiceTest) InspectHostByName(ctx context.Context, name string) (ahf *abstract.HostFull, ferr fail.Error) {
	...
	ahf.CurrentState = ahf.LastState
...
func (e *ServiceTest) _CreateCluster(ctx context.Context, request abstract.ClusterRequest, shorten bool) (*abstract.Cluster, fail.Error) { // nolint
	...
	if err != nil {
		return &abstract.Cluster{}, fail.Wrap(err)
	}
	...
	if !e._hasInternalData(fmt.Sprintf("hosts/ByID/gw-%s", name)) {
		...
		xerr = gw.Alter(ctx, func(p clonable.Clonable, props *serialize.JSONProperties) fail.Error {
			_, err := clonable.Cast[*abstract.HostCore](p)
			if err != nil {
				return fail.Wrap(err)
			}
			innerXErr := props.Alter(hostproperty.NetworkV2, func(p clonable.Clonable) fail.Error {
				hnV2, err := clonable.Cast[*propertiesv2.HostNetworking](p)
				if err != nil {
					return fail.Wrap(err)
				}
	...
	if shorten { // To make cluster.Create localresult without have to folow procedure
		...
		if !ok {
			return aci, fail.Wrap(errors.New("resource.Cluster not castable to operation.Cluster"))
		}
...
func (e *ServiceTest) GetRawAuthenticationOptions(ctx context.Context) (stacks.AuthenticationOptions, fail.Error) {
	e._survey("ServiceTest::AuthenticationOptions (not implemented)")
...
func (e *ServiceTest) GetConfigurationOptions(ctx context.Context) (providers.Config, fail.Error) {
	...
	cfg.Set("DNSServers", []string{"8.8.8.8", "4.4.4.4"})
	...
	/*
		 ...
		 xerr = Bucket.Alter(func(_ clonable.Clonable, props *serialize.JSONProperties) fail.Error {
			 return props.Alter(bucketproperty.MountsV1, func(p clonable.Clonable) fail.Error {
				 mountsV1, err := clonable.Cast[*propertiesv1.BucketMounts)
				 if !ok {
...
func (e *SSHConnectorTest) Close() fail.Error {
	e.svc._survey("SSHConnectorTest::Terminate (not implemented)")
	return nil
}

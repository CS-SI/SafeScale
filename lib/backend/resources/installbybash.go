...
func (i *bashInstaller) Check(ctx context.Context, f *Feature, t Targetable, v data.Map[string, any], opts ...options.Option) (r rscapi.Results, ferr fail.Error) {
	r = nil
...
func (i *bashInstaller) Add(ctx context.Context, f *Feature, t Targetable, v data.Map[string, any], opts ...options.Option) (r rscapi.Results, ferr fail.Error) {
	r = nil
	defer fail.OnPanic(&ferr)
...
func (i *bashInstaller) Remove(ctx context.Context, f *Feature, t Targetable, v data.Map[string, any], opts ...options.Option) (r rscapi.Results, ferr fail.Error) {
	r = nil
	defer fail.OnPanic(&ferr)

...
import (
	...
	"github.com/CS-SI/SafeScale/v22/lib/backend/resources/api"
...
func FeatureSettingsFromProtocolToResource(in *protocol.FeatureSettings) rscapi.FeatureSettings {
	if in == nil {
		return rscapi.FeatureSettings{}
	}

...
func New(opts AuthOpts) (*Stack, error) {
...
func (s *Stack) GetImage(id string) (*api.Image, error) {
...
func (s *Stack) GetTemplate(id string) (*api.HostTemplate, error) {
...
func (s *Stack) ListTemplates(all bool) ([]api.HostTemplate, error) {
	input := pricing.GetProductsInput{
		Filters: []*pricing.Filter{
			{
				Field: aws.String("ServiceCode"),
...
func (s *Stack) CreateKeyPair(name string) (*api.KeyPair, error) {
...
func (s *Stack) GetKeyPair(id string) (*api.KeyPair, error) {
...
func (s *Stack) ListKeyPairs() ([]api.KeyPair, error) {
	out, err := c.EC2.DescribeKeyPairs(&ec2.DescribeKeyPairsInput{})
	if err != nil {
		return nil, err
	}
...
func (s *Stack) saveNetwork(n api.Network) error {
...
func (s *Stack) getNetwork(netID string) (*api.Network, error) {
...
func (s *Stack) removeNetwork(netID string) error {
	return c.DeleteObject("gpac.aws.networks", netID)
}

//CreateNetwork creates a network
func (s *Stack) CreateNetwork(req api.NetworkRequest) (*api.Network, error) {
...
func (s *Stack) GetNetwork(id string) (*api.Network, error) {
...
func (s *Stack) ListNetworks() ([]api.Network, error) {
	out, err := c.EC2.DescribeVpcs(&ec2.DescribeVpcsInput{})
	if err != nil {
		return nil, err
	}
...
func (s *Stack) CreateGateway(req api.GWRequest) (*api.Host, error) {
...
func (s *Stack) getSubnets(vpcIDs []string) ([]*ec2.Subnet, error) {
	filters := []*ec2.Filter{}
...
func (s *Stack) prepareUserData(request api.HostRequest, kp *api.KeyPair, gw *api.Host) (string, error) {
...
func (s *Stack) saveHost(host api.Host) error {
	var buffer bytes.Buffer
...
func (s *Stack) removeHost(hostID string) error {
	return c.DeleteObject("gpac.aws.wms", hostID)
}
func (s *Stack) readHost(hostID string) (*api.Host, error) {
...
func (s *Stack) CreateHost(request api.HostRequest) (*api.Host, error) {
...
func (s *Stack) GetHost(id string) (*api.Host, error) {
...
func (s *Stack) ListHosts() ([]api.Host, error) {
...
func (s *Stack) GetSSHConfig(hostID string) (*system.SSHConfig, error) {
...
func (s *Stack) saveVolumeName(id, name string) error {
...
func (s *Stack) getVolumeName(id string) (string, error) {
...
func (s *Stack) removeVolumeName(id string) error {
...
func (s *Stack) CreateVolume(request api.VolumeRequest) (*api.Volume, error) {
...
func (s *Stack) GetVolume(id string) (*api.Volume, error) {
...
func (s *Stack) ListVolumes() ([]api.Volume, error) {
	out, err := c.EC2.DescribeVolumes(&ec2.DescribeVolumesInput{})
	if err != nil {
		return nil, err
	}
...
// func (s *Stack) saveVolumeAttachmentName(id, name string) error {
...
// func (s *Stack) getVolumeAttachmentName(id string) (string, error) {
...
// func (s *Stack) removeVolumeAttachmentName(id string) error {
...
func (s *Stack) CreateVolumeAttachment(request api.VolumeAttachmentRequest) (*api.VolumeAttachment, error) {
...
func (s *Stack) GetVolumeAttachment(serverID, id string) (*api.VolumeAttachment, error) {
	out, err := c.EC2.DescribeVolumes(&ec2.DescribeVolumesInput{
		VolumeIds: []*string{aws.String(id)},
	})
	if err != nil {
...
func (s *Stack) ListVolumeAttachments(serverID string) ([]api.VolumeAttachment, error) {
	out, err := c.EC2.DescribeVolumes(&ec2.DescribeVolumesInput{
		Filters: []*ec2.Filter{
			&ec2.Filter{
				Name:   aws.String("attachment.instance-id"),

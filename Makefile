...
validtest: vettest
	...
	@cd integrationtests && $(GO) test -v -tags integration,buckettests ./... 2>&1 | $(TEE) -a ./integration_results.log || true
	...
	@cd integrationtests && $(GO) test -v -tags integration,featuretests ./... 2>&1 | $(TEE) -a ./integration_results.log || true
	@cd integrationtests && $(GO) test -v -tags integration,volumetests ./... 2>&1 | $(TEE) -a ./integration_results.log || true
	@cd integrationtests && $(GO) test -v -tags integration,sharetests ./... 2>&1 | $(TEE) -a ./integration_results.log || true

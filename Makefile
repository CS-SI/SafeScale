...
ci: logclean ground getdevdeps mod sdk generate lib cli minimock err vet semgrep
	@printf "%b" "$(OK_COLOR)$(OK_STRING) Build, branch $$(git rev-parse --abbrev-ref HEAD) SUCCESSFUL $(NO_COLOR)\n";

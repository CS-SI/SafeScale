...
broker: utils system providers
	@printf "%b" "$(OK_COLOR)$(INFO_STRING) Building broker, $(NO_COLOR)target $(OBJ_COLOR)$(@)$(NO_COLOR)\n";
	@(cd broker && $(MAKE) all)

deploy: utils system providers broker
	@printf "%b" "$(OK_COLOR)$(INFO_STRING) Building deploy, $(NO_COLOR)target $(OBJ_COLOR)$(@)$(NO_COLOR)\n";
	@(cd deploy && $(MAKE) all)

perform: utils system providers broker
	@printf "%b" "$(OK_COLOR)$(INFO_STRING) Building perform, $(NO_COLOR)target $(OBJ_COLOR)$(@)$(NO_COLOR)\n";
	@(cd perform && $(MAKE) all)
...
broker/daemon/brokerd: broker
	@printf "%b" "$(OK_COLOR)$(INFO_STRING) Building broker daemon, $(NO_COLOR)target $(OBJ_COLOR)$(@)$(NO_COLOR)\n";

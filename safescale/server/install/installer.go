...
//go:generate mockgen -destination=../mocks/mock_installer.go -package=mocks github.com/CS-SI/SafeScale/safescale/server/install Installer

import "github.com/CS-SI/SafeScale/safescale/server/install/enums/Method"

...
`broker vm inspect <VM_name_or_id>`|Get info on a VM<br><br>success response: `{"ID":"2ab6786a-64e8-430a-94a7-e4404a91e7ae","Name":"example_vm_master","CPU":4,"RAM":15,"Disk":100,"IP":"192.168.0.5","State":2,"PrivateKey":"-----BEGIN RSA PRIVATE KEY-----\n[...]-----END RSA PRIVATE KEY-----\n","GatewayID":"e2d336e7-3cbc-48bc-a5c2-efd5d4ece5c0"}`<br><br>failure response: `Could not inspect vm 'fake_vm': rpc error: code = Unknown desc = VM fake_vm does not exist`
`broker vm ssh <VM_name_or_id>`|Get ssh config to connect to VM<br><br>success response:`{"User":"gpac","Host":"192.168.0.5","PrivateKey":"-----BEGIN RSA PRIVATE KEY-----\n[...]-----END RSA PRIVATE KEY-----\n","Port":22,"gateway":{[...]}}`<br><br>response error:`Could not get ssh config for vm 'fake_vm': rpc error: code = Unknown desc = VM 'fake_vm' does not exist`
`broker vm delete <VM_name_or_id>`| Delete a VM<br><br>success response: `VM 'example_vm' deleted`<br><br>failure response: `Could not delete vm 'example_vm': rpc error: code = Unknown desc = VM 'example_vm' does not exist`

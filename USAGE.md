...
`broker vm inspect <VM_name_or_id>`|Get info on a VM<br><br>success response: `{"ID":"2ab6786a-64e8-430a-94a7-e4404a91e7ae","Name":"example_vm_master","CPU":4,"RAM":15,"Disk":100,"IP":"192.168.0.5","State":2,"PrivateKey":"-----BEGIN RSA PRIVATE KEY-----\n[...]-----END RSA PRIVATE KEY-----\n","GatewayID":"e2d336e7-3cbc-48bc-a5c2-efd5d4ece5c0"}`<br><br>failure response: `Could not inspect vm 'fake_vm': rpc error: code = Unknown desc = VM fake_vm does not exists`
`broker vm ssh <VM_name_or_id>`|Get ssh config to connect to VM<br><br>success response:`{"User":"gpac","Host":"192.168.0.5","PrivateKey":"-----BEGIN RSA PRIVATE KEY-----\n[...]-----END RSA PRIVATE KEY-----\n","Port":22,"gateway":{[...]}}`<br><br>response error:`Could not get ssh config for vm 'fake_vm': rpc error: code = Unknown desc = VM 'fake_vm' does not exists`
`broker vm delete <VM_name_or_id>`| Delete a VM<br><br>success response: `VM 'example_vm' deleted`<br><br>failure response: `Could not delete vm 'example_vm': rpc error: code = Unknown desc = VM 'example_vm' does not exists`
...
`broker volume inspect <volume_name_or_id>`|Get info on a volume.<br><br>success response: `{"ID":"727204a8-9b15-43c6-b2da-e641a2c90876","Name":"example_volume","Speed":1,"Size":10}`<br><br>failure response: `Could not get volume 'fake_volume': rpc error: code = Unknown desc = Volume 'fake_volume' does not exists`
`broker volume attach [options] <volume_name_or_id>`|Attach the volume to a VM. It mounts the volume on a directory of the VM. The directory is created if it does not already exists.<br>Options:<ul><li>`--path value` Mount point of the volume (default: "/shared/<volume_name>)</li><li>`--format value` Filesystem format (default: "ext4")</li></ul>success response: `Volume 'example_volume' attached to vm 'example_vm_master'`<br><br>failure response 1: `Could not attach volume 'fake_volume' to VM 'example_vm': rpc error: code = Unknown desc = No volume found with name or id 'fake_volume'`<br><br>failure response 2: `Could not attach volume 'example_volume' to VM 'fake_vm': rpc error: code = Unknown desc = No VM found with name or id 'fake_vm'`
`broker volume detach <volume_name_or_id> <vm_name_or_id>`|Detach a volume from a VM<br><br>success response:`Volume 'example_volume' detached from VM 'example_vm'`<br><br>failure response 1:`Could not detach volume 'fake_volume' from VM 'example_vm': rpc error: code = Unknown desc = No volume found with name or id 'fake_volume'`<br><br>failure response 2:`Could not detach volume 'example_volume' from VM 'fake_vm': rpc error: code = Unknown desc = No VM found with name or id 'fake_vm'`
`broker volume delete <volume_name_or_id>`| Delete the volume with the given name.<br><br>success response: `Volume 'eaf46ce8-ef14-4e10-b33f-c1a5c25c5f98' deleted`<br><br>failure response: `Could not delete volume 'other_volume': rpc error: code = Unknown desc = Volume 'other_volume' does not exists`<br><br>failure response: `Could not delete volume '727204a8-9b15-43c6-b2da-e641a2c90876': rpc error: code = Unknown desc = Error deleting volume: Invalid request due to incorrect syntax or missing required parameters.`
...
`broker nas mount [options] <NAS_name> <VM_name_or_id>`|Mount an exported nfs directory on a VM<br>Options:<ul><li>`--path value` Path to mount nfs directory on (default: /data)</li></ul>success response: _empty_<br><br>failure response: `Could not mount nfs directory: rpc error: code = Unknown desc = Unable to find Nas 'fake_nas'`<br><br>failure response: `Could not mount nfs directory: rpc error: code = Unknown desc = Unable to find VM 'fake_vm'`
`broker nas list`|List all created NAS<br><br>response: `[{"Nas":{"Name":"example_nas"},"VM":{"ID":"a8dd08af-de24-4ba5-b8ee-e9567188e6af"},"path":"/shared/data","isServer":true}]`
`broker nas inspect <NAS_name>`|List the nfs server ans all clients connected to it.<br><br>success response: `[{"Nas":{"Name":"example_nas"},"VM":"ID":"a8dd08af-de24-4ba5-b8ee-e9567188e6af"},"path":"/shared/data","isServer":true},{"Nas":{"Name":"example_nas"},"VM":{"ID":"81419528-bd4a-427b-a5e6-7d63a1459b8d"},"path":"/data"}]`
`broker nas umount <NAS_name> <VM_name_or_id>`|Umount an exported nfs directory on a VM<br><br>success response: _empty_<br><br>failure response: `Could not umount nfs directory: rpc error: code = Unknown desc = Unable to find Nas 'fake_nas'`<br><br>failure response: `Could not umount nfs directory: rpc error: code = Unknown desc = Unable to find VM 'fake_vm'`
...
`broker container inspect <container_name>`|Get info on a container<br><br>success response: `{"Container":"example_container","VM":{"Name":""},"Path":""}`<br><br>failure response: `Could not inspect container 'fake_container': rpc error: code = Unknown desc = Error getting container fake_container: Resource not found`
`broker container mount [options] <container_name> <VM_name_or_id>`|Mount a container on the filesusteme of a VM.<br>Options:<ul><li>`--path value` Mount point of the container (default: "/containers/<container_name>"</li></ul>success response: `Container 'example_container' mounted on '/containers/' on VM 'example_vm'`<br><br>failure response: `Could not mount container 'fake_container': rpc error: code = Unknown desc = Error getting container fake_container: Resource not found`<br><br>failure response: `Could not mount container 'example_container': rpc error: code = Unknown desc = No VM found with name or id 'fake_vm'`
`broker container umount <container_name> VM_name_or_id>`|Umount a container from the filesystem of a VM.<br><br>success message:`Container 'example_container' umounted from VM 'example_vm'`<br><br>failure message: `Could not umount container 'fake_container': rpc error: code = Unknown desc = Error getting container fake_container: Resource not found`
...
#### ssh
The following commands deals with ssh commands to be executed on a VM.

command | description
--- | ---
`broker ssh run [options] <VM_name_or_id>`|Run a command on the VM<br>Options:<ul><li>`-c value` The command to execute</li></ul>ex: `broker ssh run -c "ls -la ~" example_vm`<br><br>response:<br>total 32<br>drwxr-xr-x 4 gpac gpac 4096 Jun  5 13:25 .<br>drwxr-xr-x 4 root root 4096 Jun  5 13:00 ..<br>-rw------- 1 gpac gpac   15 Jun  5 13:25 .bash_history<br>-rw-r--r-- 1 gpac gpac  220 Aug 31  2015 .bash_logout<br>-rw-r--r-- 1 gpac gpac 3771 Aug 31  2015 .bashrc<br>drwx------ 2 gpac gpac 4096 Jun  5 13:01 .cache<br>-rw-r--r-- 1 gpac gpac    0 Jun  5 13:00 .hushlogin<br>-rw-r--r-- 1 gpac gpac  655 May 16  2017 .profile<br>drwx------ 2 gpac gpac 4096 Jun  5 13:00 .ssh
`broker ssh copy <src> <dest>`|Copy a local file/directory to a VM or copy from VM to local<br><br>ex: `broker ssh copy /my/local/file example_vm:/remote/path`
`broker ssh connect <VM_name_or_id>`|Connect to the VM with interactive shell<br><br>ex: ` broker ssh connect example_vm`<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`gpac@example-vm:~$`

...
func (client *Client) CreateVolumeAttachment(request model.VolumeAttachmentRequest) (*model.VolumeAttachment, error) {
	...
	if err != nil {
		// Detach volume
		detachErr := volumeattach.Delete(client.osclt.Compute, va.ServerID, va.ID).ExtractErr()
		if detachErr != nil {
...
func (client *Client) DeleteVolume(id string) error {
	...
	if volume == nil {
		return errors.Wrap(model.ResourceNotFoundError("volume", id), "Cannot delete volume")
	}

...
var containerList = cli.Command{
	...
	Action: func(c *cli.Context) error {
		...
		if err != nil {
			return fmt.Errorf("%v", client.DecorateError(err, "list of containers", false))
		}
...
var containerCreate = cli.Command{
	...
	Action: func(c *cli.Context) error {
		...
		if err != nil {
			return fmt.Errorf("%v", client.DecorateError(err, "creation of container", true))
		}
		return nil
	},
}
...
var containerDelete = cli.Command{
	...
	Action: func(c *cli.Context) error {
		...
		if err != nil {
			return fmt.Errorf("%v", client.DecorateError(err, "deletion of container", true))
		}
		return nil
	},
}
...
var containerInspect = cli.Command{
	...
	Action: func(c *cli.Context) error {
		...
		if err != nil {
			return fmt.Errorf("%v", client.DecorateError(err, "inspection of container", false))
		}
...
var containerMount = cli.Command{
	...
	Action: func(c *cli.Context) error {
		...
		if err != nil {
			return fmt.Errorf("%v", client.DecorateError(err, "mount of container", true))
		}
...
var containerUnmount = cli.Command{
	...
	Action: func(c *cli.Context) error {
		...
		if err != nil {
			return fmt.Errorf("%v", client.DecorateError(err, "unmount of container", true))
		}

...
func (m *NasName) Reset()                    { *m = NasName{} }
func (m *NasName) String() string            { return proto.CompactTextString(m) }
func (*NasName) ProtoMessage()               {}
func (*NasName) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{25} }

func (m *NasName) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
type NasDefinition struct {
	Nas  *NasName   `protobuf:"bytes,1,opt,name=Nas,json=nas" json:"Nas,omitempty"`
	VM   *Reference `protobuf:"bytes,2,opt,name=VM,json=vM" json:"VM,omitempty"`
	Path string     `protobuf:"bytes,3,opt,name=path" json:"path,omitempty"`
}

func (m *NasDefinition) Reset()                    { *m = NasDefinition{} }
func (m *NasDefinition) String() string            { return proto.CompactTextString(m) }
func (*NasDefinition) ProtoMessage()               {}
func (*NasDefinition) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{26} }

func (m *NasDefinition) GetNas() *NasName {
	if m != nil {
		return m.Nas
	}
	return nil
...
func (m *NasDefinition) GetVM() *Reference {
	if m != nil {
		return m.VM
	}
	return nil
...
func (m *NasDefinition) GetPath() string {
	if m != nil {
		return m.Path
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*NasName)(nil), "NasName")
	proto.RegisterType((*NasDefinition)(nil), "NasDefinition")
...
// Client API for NasService service

type NasServiceClient interface {
	Create(ctx context.Context, in *NasDefinition, opts ...grpc.CallOption) (*google_protobuf.Empty, error)
}
...
func NewNasServiceClient(cc *grpc.ClientConn) NasServiceClient {
	return &nasServiceClient{cc}
}

func (c *nasServiceClient) Create(ctx context.Context, in *NasDefinition, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	out := new(google_protobuf.Empty)
	err := grpc.Invoke(ctx, "/NasService/Create", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// Server API for NasService service

type NasServiceServer interface {
	Create(context.Context, *NasDefinition) (*google_protobuf.Empty, error)
}

func RegisterNasServiceServer(s *grpc.Server, srv NasServiceServer) {
	s.RegisterService(&_NasService_serviceDesc, srv)
}
...
func _NasService_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/NasService/Create",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NasServiceServer).Create(ctx, req.(*NasDefinition))
	}
	return interceptor(ctx, in, info, handler)
}

var _NasService_serviceDesc = grpc.ServiceDesc{
...
var fileDescriptor0 = []byte{
	...
	,
}

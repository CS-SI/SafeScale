...
func Test_SecurityGroupCreate(t *testing.T) {
	helpers.InSection("securitygroups").Clear().AddScenario(CreateAndDeleteNetworkSecurityGroup).AddScenario(OpenPortClosedByDefaultInGateway).AddScenario(GwFirewallWorks)
